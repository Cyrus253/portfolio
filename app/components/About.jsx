...
>
  {infoList.map(({ icon, iconDark, title, description }, index) => (
    <motion.li
      ...
      className='rounded-2xl p-6 transition-transform duration-300 group border border-gray-300 dark:border-white/30 hover:shadow-xl dark:hover:shadow-white/20 hover:-translate-y-1 bg-white dark:bg-white/5'
    >
      {/* Icon */}
      <div className='w-12 h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 mb-4'>
        <Image
